...
class _BoardScreenState extends State<BoardScreen> {
  ...
  void onPlayerClick(int index) {
    ...
    if (checkWinner('X')) {
      player1Score += 5;
      showResult('The Winner is ${player1Name}', player1Score, player2Score,
          player1Name, player2Name);
      previousWinner = true;
      initBoard();
    } else if (checkWinner("O")) {
      player2Score += 5;
      showResult('The Winner is ${player2Name}', player1Score, player2Score,
          player1Name, player2Name);
      previousWinner = false;
      initBoard();
    } else if (counter == 9) {
      showResult(
          'Draw !!', player1Score, player2Score, player1Name, player2Name);
      previousWinner = true;
      //draw
      initBoard();
    }
  ...
  void showResult(
      String text, int score1, int score2, String player1, String player2) {
    showDialog(
      context: context,
